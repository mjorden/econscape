...
- The academic style is now the default. `set_style("economist")`
  restores the newspaper look; nothing else about either style changes.
  The README figures, the pkgdown accent and the package description
  follow.

## econscape 0.12.0

The package is now called **econscape**. It began as a FRED client with
an Economist-style theme and grew into consumer, producer and market
theory, price discrimination, an econometrics toolkit and a second house
style; the old name described a tenth of it. Nothing else changes: every
function keeps its name (the `fred_*` functions are named for their data
source, which is still FRED), the options are now `econscape.style` and
`econscape.base_url`, and the GitHub repository redirects from the old
address.
...
- `utility_table(tu_x, tu_y)` – preferences given as a table of total
  ...
  [`mrs()`](https://mjorden.github.io/econscape/reference/mrs.md) uses
...
([\#18](https://github.com/mjorden/econscape/issues/18)), settled before
a 1.0.
...
([\#17](https://github.com/mjorden/econscape/issues/17)). No API
changes.
...
- The market solvers are now two named primitives instead of one:
  ...
  [`third_degree()`](https://mjorden.github.io/econscape/reference/price_discrimination.md)’s
...
Econometrics ([\#21](https://github.com/mjorden/econscape/issues/21)):
...
([\#19](https://github.com/mjorden/econscape/issues/19)). No user-facing
behaviour changes.
...
([\#15](https://github.com/mjorden/econscape/issues/15)):
...
Market structure
([\#13](https://github.com/mjorden/econscape/issues/13)): the demand
...
Producer theory ([\#8](https://github.com/mjorden/econscape/issues/8)),
...
[\#4](https://github.com/mjorden/econscape/issues/4), now has a caller
(`fixed = 0` is a valid cost).
[\#4](https://github.com/mjorden/econscape/issues/4) is closed by this
release.

## econscape 0.5.0

The substitution / income decomposition of a price change
([\#7](https://github.com/mjorden/econscape/issues/7)):
...
([\#6](https://github.com/mjorden/econscape/issues/6)):
...
[`indifference_curve()`](https://mjorden.github.io/econscape/reference/indifference_curve.md),
[`optimal_bundle()`](https://mjorden.github.io/econscape/reference/optimal_bundle.md)
and [`mrs()`](https://mjorden.github.io/econscape/reference/mrs.md)
methods that
[`cobb_douglas()`](https://mjorden.github.io/econscape/reference/cobb_douglas.md)
has ([\#5](https://github.com/mjorden/econscape/issues/5)):
...
- The finite-difference fallback in
  [`mrs()`](https://mjorden.github.io/econscape/reference/mrs.md) now
